...
class AppConstants {
  ...
  static const String walletRate =
      '/api/wallet/rate'; // ດຶງ BTC/LAK rate ປັດຈຸບັນ
  static const String walletTopup =
      '/api/wallet/topup'; // ສ້າງ invoice ສຳລັບ top-up
  ...
  static const String paymentDecode =
      '/api/payment/decode'; // ຖອດລະຫັດ invoice ກ່ອນຈ່າຍ
  static const paymentLaoQR = '/api/payment/laoqr/pay';
  static const paymentLaoQRLimit =
      '/api/payment/laoqr/limit-status'; // ວົງເງິນ LAO QR
  static const paymentTransfer =
      '/api/payment/transfer'; // ໂອນລະຫວ່າງ wallet (ຍັງ implement ບໍ່ຄົບ)
  ...
  static const String kycVerify =
      '/api/kyc/verify'; // PUT  admin review (ຕ້ອງຕໍ່ທ້າຍດ້ວຍ /:userId)
  ...
  static const String appScheme =
      'sabaidee'; // deep link scheme: sabaidee://home

  // ─── Withdrawal Endpoints ────────────────────────────────────────────────
  static const String withdrawalLimitStatus = '/api/withdrawal/limit-status';
  static const String withdrawalPreview =
      '/api/withdrawal/preview'; // ກວດ limit ກ່ອນຖອນ
